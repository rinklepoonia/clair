    ...
    return (
        ...
        <Container>
            ...
            <Accordion defaultActiveKey="0" className='max_w_800 mx-auto'>
                <Accordion.Item eventKey="0" className='mb-4 p_12'>
                ...
                <Accordion.Item eventKey="1" className='mb-4 p_12'>
                ...
                <Accordion.Item eventKey="2" className='mb-4 p_12'>
                ...
                <Accordion.Item eventKey="3" className='mb-4 p_12'>
                ...
                <Accordion.Item eventKey="4" className='mb-4 p_12'>
                ...
                <Accordion.Item eventKey="5" className='mb-4 p_12'>
                ...
                <Accordion.Item eventKey="6" className='mb-4 p_12'>
