            ...
            <Container>
                <div className='d-flex justify-content-center'>
                    <div data-aos="zoom-in" className='socials_bg_img socialBox_modifacition z_1 mt-md-0 mt-3'>
                        <h3 className='ff_manrope fw-semibold text48_2xl lh_md_57 lh_36 color_white text-center mb-lg-4 mb-md-0'>Our <span className='color_yellow'>Socials</span></h3>
                        <p className='ff_mamrope fw-normal text16_sm lh_24 color_lightGrey mb-lg-4 mb-sm-2 mb-1 text-center'>Join us on social media for exclusive giveaways and stay connected!</p>
                        <p className='ff_manrope fw-normal text20_md lh_sm_30 lh_21 color_yellow text-center mb-3 pb-lg-3 pb-0'>“Exciting Releases of 'Bad Players' Avatars Coming Soon: Be Ready for the Fun!"</p>
