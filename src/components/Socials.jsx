        ...
        <div className='position-relative socialSection_padding mt_60'>
            ...
            <Container>
                <div className='d-flex justify-content-center'>
                    <div className='socials_bg_img socialBox_modifacition z_1 mt-md-0 mt-3'>
                        ...
                        <div className='d-flex gap-3 align-items-center justify-content-center'>
                            <a href='https://discord.com/' target='_blank' className='Social_IconBox d-flex justify-content-center align-items-center'><Discord /></a>
                            <a href='https://x.com/?lang=en' target='_blank' className='Social_IconBox d-flex justify-content-center align-items-center'><Twitter /></a>
                            <a href='https://telegram.org/' target='_blank' className='Social_IconBox d-flex justify-content-center align-items-center'><Telegram /></a>
                        </div>
                    </div>
                </div>
            </Container>
