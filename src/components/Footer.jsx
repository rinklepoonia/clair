...
function Footer() {
    return (
        <div className='footer_padding footer_bg_img position-relative'>
            ...
            <Container>
                <h4 className='ff_manrope fw-semibold text60_3xl lh_sm_72 lh_48 color_yellow mb-lg-3 mb-1 pb-xl-1 pb-0 text-center'>$CLAIR</h4>
                <p className='ff_manrope fw-normal text16_sm lh_24 color_lightGrey max_w_626 text-center pb-xl-5 pb-3  mb-0 mx-auto'>In this meme-driven world, laughter is not just a reaction; it's a powerful tool for chang
                    <span className='d-lg-block d-none'>and Baby Sinclair is wielding it with style. The bad players better watch out;</span>
